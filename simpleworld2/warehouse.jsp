			...
			<div id="content">
				<div class="post">
					...
					<div style="padding: 3px; background-color: rgb(226, 222, 203); border-radius: 3px 3px 3px 3px;">
						<a href="warehouse_form.jsp"><input type="button" value="+ New Warehouse" style="padding: 3px;"></a>
						&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;
				...
				try
				{
					...
					String QueryString = "SELECT default_warehouse from warehouse";
				...
				<div class="post">
					<p><a href="display_warehouse.jsp?value=<%=rs.getString(1)%>"><%=rs.getString(1)%></a></p>
				</div>
				<% 	
					} 
					rs.close();
