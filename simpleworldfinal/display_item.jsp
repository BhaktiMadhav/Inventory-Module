...
<%
	...
	{			
		...
		else
		{
			...
			z2="select display from permission where ur_id=\'"+t+"\' and page_name='item' ";
			...
			{
				String url = new String("http://localhost:8080/simpleworld/display_item.jsp?value="+p1);
			...
			z2="select update_form from permission where ur_id=\'"+t+"\' and page_name='item' ";
			rs2=st2.executeQuery(z2);
			String flag_update="";
			while(rs2.next())
			{
			...
			z2="select delete_form from permission where ur_id=\'"+t+"\' and page_name='item' ";
			rs2=st2.executeQuery(z2);
			String flag_delete="";
			while(rs2.next())
			{
...
<table>	
	...
	<tr>
		...
		<td><br><% if(flag_delete.equals("true")){%><a href="delete_item.jsp?value=<%=rs.getString(1)%>"><input type="button" value="Delete" style="padding: 3px;"><%}%></td>
	</tr>
	<%		
