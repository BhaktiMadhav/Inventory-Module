...
<div id="wrapper">
	<div id="wrapper2">
		...
		<div id="page">
			<div id="content">
				<div class="post">
					<h2 class="title"><a href="item.jsp">Item List </a></h2>
					<div style="padding: 3px; background-color: rgb(226, 222, 203); border-radius: 3px 3px 3px 3px;">
		
						<form name="search" action="search_item.jsp"><br>
						<% if(flag_form.equals("true")){%><a href="item_form.jsp" ><input type="button" value="+ New Item" style="padding: 3px;"></a><%}%>
						&nbsp;&nbsp;
						
						&nbsp;&nbsp;
						
						<input type="text" style="height: 30px; width: 180px; margin-left: 24px; border: 1px solid rgb(170, 170, 170);  border-radius: 3px 3px 3px 3px;" name="itemname">
						&nbsp;&nbsp;
				...
				<%if(flag_list.equals("true"))
				{
					...
					String QueryString = "SELECT item_code,item_group from item where item_group LIKE '"+itemname+"%'";
				 ...
				 <div class="post">
					<p><a href="display_item.jsp?value=<%=rs2.getString(1)%>"><%=rs2.getString(1)%></a> &nbsp; <%=rs2.getString(2)%></p>
				</div>
				<% 	
				}
				String url = new String("http://localhost:8080/simpleworld/search_item.jsp");
