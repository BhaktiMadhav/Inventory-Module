...
<%
	...
	{			
		...
		else
		{
			...
			z2="select delete_form from permission where ur_id=\'"+t+"\' and page_name='warehouse' ";
			...
			{
				String url = new String("http://localhost:8080/simpleworld/delete_warehouse.jsp");
...
<div id="wrapper">
	...
	String warehouse=p1.trim();
		...
		String sql = "DELETE from warehouse WHERE default_warehouse = '"+warehouse+"'";
		int delete = st2.executeUpdate(sql);
		
		if(delete == 1)
		{
			out.println(warehouse+" deleted Successfully!");
		}
		else
		{
