...
<html>
		...
		String z2;
		z2="select form from permission where ur_id=\'"+t+"\' and page_name='uom' ";
		...
		z2="select list from permission where ur_id=\'"+t+"\' and page_name='uom'";
        rs2=st2.executeQuery(z2);
        String flag_list="";
        while(rs2.next())
        {
		...
		<div id="page">
			<div id="content">
				<div class="post">
					...
					<form name="search" action="search_uom.jsp"><br>
						<%if(flag_form.equals("true")){%><a href="uom_form.jsp"><input type="button" value="+ New UOM" style="padding: 3px;"></a><%}%>
						&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="text" style="height: 30px; width: 180px; margin-left: 24px; border: 1px solid rgb(170, 170, 170);  border-radius: 3px 3px 3px 3px;" name="uom">
						&nbsp;&nbsp;
				...
				<%if(flag_list.equals("true"))
				{
					...
					String QueryString = "SELECT default_uom from uom where default_uom LIKE '"+uom+"%'";
				...
				<div class="post">
					<p><a href="display_uom.jsp?value=<%=rs2.getString(1)%>"><%=rs2.getString(1)%></a> &nbsp;</p>
				</div>
				<% 	
				}
				String url = new String("http://localhost:8080/simpleworld/UOM.jsp");
