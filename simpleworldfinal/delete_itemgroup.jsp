...
<%
	...
	{			
		...
		else
		{
			...
			z2="select delete_form from permission where ur_id=\'"+t+"\' and page_name='itemgroup' ";
			...
			{
				String url = new String("http://localhost:8080/simpleworld/delete_itemgroup.jsp");
...
<div id="wrapper">
	...
	String itemgroup=p1.trim();
		...
		String sql = "DELETE FROM item_group WHERE item_group = '"+itemgroup+"'";
		int delete = st2.executeUpdate(sql);
		
		if(delete == 1)
		{
			out.println("Item Group "+itemgroup+" deleted Successfully!");
		}
		else
		{
