...
<%
		...
		{		
			...
			if(session.getAttribute("user_id")==null){  
				...
				z2="select list from permission where ur_id=\'"+t+"\' and page_name='analysis'";
				...
				if(flag_list.equals("true"))
				{
					...
					String url = new String("http://localhost:8080/simpleworld/analysis.jsp");
			...
			<div id="content">
				<div class="post">
					...
					<div style="width: 48%; float: left;">
						<a href="customer_by_region_graph.jsp"><font size="4">Customers By Region</font></a><br> 
						
						<br><br><br>
					</div>
					<div style="width: 48%; float: right;">
							<a href="vendor_by_region_graph.jsp"><font size="4">Vendors By Region</font></a><br>   
