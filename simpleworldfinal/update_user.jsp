...
<%
	...
	{		
		...
		else
		{
			...
			{
				String url = new String("http://localhost:8080/simpleworld/update_user.jsp");
...
<%
				...
				String p6=request.getParameter("user_id");
				String user_id=p6.trim();
				...
				sql = "UPDATE user SET name=?,address=?,salary=?,ur_id=? WHERE user_id=?";
