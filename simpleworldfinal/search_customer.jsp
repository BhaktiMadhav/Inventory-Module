...
<div id="wrapper">
	<div id="wrapper2">
		...
		<div id="page">
			<div id="content">
				<div class="post">
					<h2 class="title"><a href="customer.jsp">Customer List </a></h2>
					<div style="padding: 3px; background-color: rgb(226, 222, 203); border-radius: 3px 3px 3px 3px;">
					
					<form name="search" action="search_customer.jsp"><br>
				...
				String QueryString = "SELECT c_id,name from customer where name LIKE '"+name+"%'";
			...
			%>
				 ...
				 <div class="post">
					<p><a href="display_customer.jsp?value=<%=rs2.getString(1)%>"><%=rs2.getString(1)%></a> &nbsp; <%=rs2.getString(2)%></p>
				</div>
				<% 	
					}
					String url = new String("http://localhost:8080/simpleworld/search_customer.jsp");
