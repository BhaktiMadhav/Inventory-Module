...
<%
	...
	{			
		...
		else
		{
			...
			{
				String url = new String("http://localhost:8080/simpleworld/purchasereceipt_form.jsp");
		...
		<div id="page">
			<div id="content">
				<div class="post">
					...
					<h3>Purchase_Receipt_Id :  <%out.println(max);%></h3><br>
...
<table>
	...
	<tr>
		...
		<td>
		<%
					QueryString = "SELECT v_id from vendor where system_delete='false' AND status='active'";
					rs2 = st2.executeQuery(QueryString);
				%>
					<select name="v_id">
