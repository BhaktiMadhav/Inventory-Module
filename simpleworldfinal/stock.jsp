...
<%
		...
		String z2="select list from permission where ur_id=\'"+t+"\' and page_name='stock'";
		...
		{
		String url = new String("http://localhost:8080/simpleworld/stock.jsp");
...
<div id="wrapper">
	<div id="wrapper2">
		...
		<div id="page">
			<div id="content">
				<div class="post">
					<h2 class="title"><a href="stock.jsp">Stock</a></h2>
					<div style="border-top: 3px solid rgb(119, 119, 119);"></div>
					<br>
					<br>
					<div style="width: 52%; float: left;">
						<a href="stock_entry.jsp"><font size="4">Stock Entry</font></a><br> 
						<i>Transfer stock from one warehouse to another</i>
						<br><br><br>
						<br><br>
					</div>
					<div style="width: 44%; float: right;">
							<a href="item.jsp"><font size="4">Item</font></a><br>   
							<i>Item Master</i>
							<br><br><br>
						<a href="warehouse.jsp"><font size="4">Warehouse</font></a><br> 
						<i>Warehouse is where items are stored</i>
						<br><br>
					</div>
				</div>				
			</div>
