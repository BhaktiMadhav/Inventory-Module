...
<%
		...
		z2="select list from permission where ur_id=\'"+t+"\' and page_name='stockentry'";
		...
		String url = new String("http://localhost:8080/simpleworld/stock_entry.jsp");
...
<div id="wrapper">
	<div id="wrapper2">
		...
		<div id="page">
			<div id="content">
				<div class="post">
					<h2 class="title"><a href="stock_entry.jsp">STOCK ENTRY</a></h2>
					...
					<%
						String QueryString="SELECT * from stock_ledger";
