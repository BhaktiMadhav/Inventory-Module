...
<%
		...
		z2="select list from permission where ur_id=\'"+t+"\' and page_name='deliverynote'";
        rs2=st2.executeQuery(z2);
        String flag_list="";
        while(rs2.next())
        {
		...
		<div id="page">
			<div id="content">
				...
				<%if(flag_list.equals("true"))
				{
				 ...
				 <div class="post">
					<p><a href="display_deliverynote.jsp?value=<%=rs2.getString(1)%>"><%=rs2.getString(1)%></a> &nbsp;&nbsp; <%=rs2.getString(2)%></p>
				</div>
					<% 	
				}
				String url = new String("http://localhost:8080/simpleworld/deliverynote.jsp");
