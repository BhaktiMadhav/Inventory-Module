...
<%
	...
	{			
		...
		else
		{
			...
			z2="select display from permission where ur_id=\'"+t+"\' and page_name='warehouse' ";
			...
			{
				String url = new String("http://localhost:8080/simpleworld/display_warehouse.jsp?value="+p1);
...
<%
	...
	<a href="delete_warehouse.jsp?value=<%=rs2.getString(1)%>"><input type="button" value="Delete" style="padding: 3px;">
