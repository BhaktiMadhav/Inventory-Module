...
<%
	...
	{			
		...
		else
		{
			...
			{
				String url = new String("http://localhost:8080/simpleworld/delete_purchasereceipt.jsp");
...
<div id="wrapper">
	...
	String pr_id=p1.trim();
		...
		String sql;
		sql = "UPDATE purchase_receipt SET system_delete=? WHERE pr_id=?";
