...
<%
	...
	{	
		...
		else
		{
			...
			{
				String url = new String("http://localhost:8080/simpleworld/customer_action.jsp");
...
<%
				...
				String sql;
				sql = "INSERT INTO customer(name,address,region_name,mobile_no,system_delete,status) VALUES (?,?,?,?,?,?)";
