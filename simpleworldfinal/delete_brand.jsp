...
<%
	...
	{			
		...
		else
		{
			...
			{
				String url = new String("http://localhost:8080/simpleworld/delete_brand.jsp");
...
<div id="wrapper">
		...
		<div id="page">
			<div id="content">
				<div class="post">
					...
					<a href="brand_form.jsp"><input type="button"  value="+ New Brand" style="padding: 3px;"></a>
						&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;
						<br>
	...
	String brand=p1.trim();
		...
		String sql = "DELETE FROM brand WHERE brand = '"+brand+"'";
