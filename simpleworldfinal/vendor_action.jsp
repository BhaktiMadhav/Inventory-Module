...
<%
	...
	{	
		...
		else
		{
			...
			{
				String url = new String("http://localhost:8080/simpleworld/vendor_action.jsp");
	...
	<div id="wrapper">
		<div id="wrapper2">
			...
			<div id="page">
				<div id="content">
					<div class="post">
						<h2 class="title"><a href="vendor.jsp">Vendor</a></h2>
						<div style="padding: 3px; background-color: rgb(226, 222, 203); border-radius: 3px 3px 3px 3px;">
						<a href="vendor_form.jsp"><input type="button"  value="+ New Item" style="padding: 3px;"></a>
						&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;
							<br>
...
<%
	...
	String p5=request.getParameter("status");
	String status=p5.trim();
	...
	String sys_del="false";
		...
		String sql;
		sql = "INSERT INTO vendor(name,address,region,mobile_no,system_delete,status) VALUES (?,?,?,?,?,?)";
