...
<%
	...
	{			
		...
		else
		{
			...
			{
				String url = new String("http://localhost:8080/simpleworld/delete_user.jsp");
...
<%
				...
				String p6=request.getParameter("value");
				...
				String sql;
				sql = "UPDATE user SET system_delete=? WHERE user_id=?";
