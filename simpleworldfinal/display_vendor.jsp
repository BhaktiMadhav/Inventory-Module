...
<%
	...
	{			
		...
		else
		{
			...
			{
				String url = new String("http://localhost:8080/simpleworld/display_vendor.jsp?value="+p1);
			...
			z2="select update_form from permission where ur_id=\'"+t+"\' and page_name='vendor' ";
			rs2=st2.executeQuery(z2);
			String flag_update="";
			while(rs2.next())
			{
			...
			z2="select delete_form from permission where ur_id=\'"+t+"\' and page_name='vendor' ";
			rs2=st2.executeQuery(z2);
			String flag_delete="";
			while(rs2.next())
			{
		...
		<div id="page">
			<div id="content">
				...
				<h2 class="title"><a href="#">Vendor </a></h2>
					...
					<% if(flag_form.equals("true")){%><a href="vendor_form.jsp" ><input type="button" value="+ New Vendor" style="padding: 3px;"></a><%}%>
						&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;
...
<%			
	...
	<tr><br>
		...
		<td><br><% if(flag_delete.equals("true")){%><a href="delete_vendor.jsp?value=<%=rs.getString(1)%>"><input type="button" value="Delete" style="padding: 3px;"></a></td><%}%>
	</tr>
	<%		
