...
<%
		...
		{		
			...
			if(session.getAttribute("user_id")==null){  
				...
				z2="select list from permission where ur_id=\'"+t+"\' and page_name='profile'";
				...
				if(flag_list.equals("true"))
				{
					...
					String url = new String("http://localhost:8080/simpleworld/profile.jsp");
...
<div id="wrapper">
	<div id="wrapper2">
		...
		<div id="page">
			<div id="content">
				<div class="post">
					<h2 class="title"><a href="profile.jsp">PROFILES</a></h2>
					<div style="border-top: 3px solid rgb(119, 119, 119);"></div>
					<br>
					<br>
					<div style="width: 48%; float: left;">
						<a href="user.jsp"><font size="4">Users</font></a><br>
						<br><br>
						<a href="vendor.jsp"><font size="4">Vendors</font></a><br>
						<br><br>

					</div>
					<div style="width: 48%; float: right;">
							<a href="customer.jsp"><font size="4">Customers</font></a><br>
							<br><br><br><br>
					</div>
				</div>				
			</div>
