...
<%
		...
		String url = new String("http://localhost:8080/simpleworld/home1.jsp");
		session.setAttribute("last_page",url);
		
		z2="select list from permission where ur_id=\'"+t+"\' and page_name='home'";
...
<div id="wrapper">
	<div id="wrapper2">
		...
		<div id="page">
			<div id="content">
				<div class="post">
					<h2 class="title"><a href="home1.jsp">HOME PAGE</a></h2>
					...
					<div style="width: 48%; float: left;">
						<a href="profile.jsp"><font size="4">Profiles</font></a><br> 
						<i>Users / Customers / Vendors</i>
						<br><br>
						<a href="stock.jsp"><font size="4">Stock</font></a><br>
						<i>Stock Entry / Item / Warehouse</i>
						<br><br>

					</div>
					<div style="width: 48%; float: right;">
							<a href="setup.jsp"><font size="4">Setup</font></a><br>
							<i>Item Group / UOM / Brand</i>
							<br><br>
							<a href="analysis.jsp"><font size="4">Analysis</font></a><br>
							<i>Customers by Region / Vendor by Region</i>
