...
<html>
		...
		z2="select list from permission where ur_id=\'"+t+"\' and page_name='itemgroup'";
        rs2=st2.executeQuery(z2);
        String flag_list="";
        while(rs2.next())
        {
...
<div id="wrapper">
	<div id="wrapper2">
		...
		<div id="page">
			<div id="content">
				<div class="post">
					<h2 class="title"><a href="itemgroup.jsp">Item Group List</a></h2>
					<div style="padding: 3px; background-color: rgb(226, 222, 203); border-radius: 3px 3px 3px 3px;">
					
					<form name="search" action="search_itemgroup.jsp"><br>
					<%if(flag_form.equals("true")){%><a href="itemgroup_form.jsp"><input type="button" value="+ New Item Group" style="padding: 3px;"></a><%}%>
						&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="text" style="height: 30px; width: 180px; margin-left: 24px; border: 1px solid rgb(170, 170, 170);  border-radius: 3px 3px 3px 3px;" name="itemgroup">
						&nbsp;&nbsp;
				...
				{
					String itemgroup=(request.getParameter("itemgroup")).trim();
					String QueryString = "SELECT item_group from item_group where item_group LIKE '"+itemgroup+"%'";
				...
				<div class="post">
					<p><a href="display_itemgroup.jsp?value=<%=rs2.getString(1)%>"><%=rs2.getString(1)%></a> &nbsp;</p>
				</div>
				<% 	
				}
				String url = new String("http://localhost:8080/simpleworld/itemgroup.jsp");
