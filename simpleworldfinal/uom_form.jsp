...
<%
	...
	{			
		...
		else
		{
			...
			{
				String url = new String("http://localhost:8080/simpleworld/uom_form.jsp");
...
<head>
	...
	function validate()
	{	
		var name = document.uomform.default_uom.value;
		if(name=="")
		{
			...
			<div id="content">
				...
				<div class="post">
					<div class="entry">
						...
						<form name="uomform" method="post" action="uom_action.jsp">
