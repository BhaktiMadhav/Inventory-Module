...
<%
	...
	{			
		...
		else
		{
			...
			z2="select display from permission where ur_id=\'"+t+"\' and page_name='itemgroup' ";
			...
			{
				String url = new String("http://localhost:8080/simpleworld/display_itemgroup.jsp?value="+p1);
...
<div id="wrapper">
	<div id="wrapper2">
		...
		<form name="itemgoup" method="post">
<%
	
	
	
	String QueryString = "SELECT * from item_group where item_group = \'"+p1+"\'";
		...
		int i=1;
			...
			<a href="delete_itemgroup.jsp?value=<%=rs2.getString(1)%>"><input type="button" value="Delete" style="padding: 3px;">
		<%		
