...
<%
	...
	try
	{
		...
		String QueryString = "SELECT * from warehouse where default_warehouse = \'"+p1+"\'";
		...
		int i=1;
			...
			%>
						WAREHOUSE<br><br>
						<input type="text" style="height: 30px; width: 250px; margin-left: 24px; border: 1px solid rgb(170, 170, 170);  border-radius: 3px 3px 3px 3px;" readonly="readonly" value="<%=rs.getString(1)%>"><br><br><br>
						
		
		
	<a href="delete_warehouse.jsp?value=<%=rs.getString(1)%>"><input type="button" value="Delete" style="padding: 3px;">
