		...
		<div id="page">
			<div id="content">
				...
				try
				{
					...
					String QueryString = "SELECT user_id,name from user where system_delete='false'";
				 ...
				 <div class="post">
					<p><a href="display_user.jsp?value=<%=rs.getString(1)%>"><%=rs.getString(1)%></a> &nbsp; <%=rs.getString(2)%></p>
				</div>
				<% 	
					} 
					rs.close();
