...
<div id="wrapper">
	...
	<div id="page">
			...
			<br><br><center>
			<fieldset><br><br>
            <b>Enter OLD Password:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="oldpass" style="height: 30px; width: 250px; margin-left: 24px; border: 1px solid rgb(170, 170, 170);  border-radius: 3px 3px 3px 3px;" value="" /><br><br><br>
			
            Enter NEW Password: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="newpass1"  style="height: 30px; width: 250px; margin-left: 24px; border: 1px solid rgb(170, 170, 170);  border-radius: 3px 3px 3px 3px;" value="" /><br><br><br>
			
			Re-Enter NEW Password: <input type="text" name="newpass2"  style="height: 30px; width: 250px; margin-left: 24px; border: 1px solid rgb(170, 170, 170);  border-radius: 3px 3px 3px 3px;" value="" /></b>
