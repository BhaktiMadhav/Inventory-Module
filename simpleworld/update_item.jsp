...
<%
	...
	{		
		...
		else
		{
			...
			{
				String url = new String("http://localhost:8080/simpleworld/update_item.jsp");
...
<%
	...
	PreparedStatement ps = null;
		...
		ps=con2.prepareStatement("UPDATE item SET item_group=?,item_name=?,brand=?,default_warehouse=?,default_uom=?,description=?,minimum_order_qty=?,cost=?,status=? WHERE item_code=?");
